...
class ScanNet:
    def __init__(self, labeled_point, experiment_dir):
        self.name = 'ScanNet'
    ...
    def load_sub_sampled_clouds(self, sub_grid_size, labeled_point, experiment_dir):
        ...
        for i, file_path in enumerate(self.all_files):
            ...
            for ii in range(40):
                ind_class = np.where(sub_labels == ii)[0]  
                num_classs = len(ind_class) 
                num_classs_all[ii] = num_classs_all[ii] + num_classs
...
if __name__ == '__main__':
    ...
    dataset = ScanNet(FLAGS.labeled_point, experiment_dir)
