...
from RandLANet_weak_pseudo import ModelTester
...
class S3DIS:
    ...
    def load_sub_sampled_clouds(self, sub_grid_size):
        ...
        for i, file_path in enumerate(self.all_files):
            ...
            if self.val_split not in cloud_name:
...
if __name__ == '__main__':
    ...
    tester = ModelTester(model, dataset, cfg.threshold, cfg.span, restore_snap=chosen_snap)
