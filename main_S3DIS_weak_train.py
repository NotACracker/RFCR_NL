...
import shutil
import random
from RandLANet_weak_train import Network
...
class S3DIS:
    def __init__(self, test_area_idx, pseudo_label_path, gt_path):
        self.name = 'S3DIS'
        self.path = '/path/to/dataset/S3DIS'
        ...
        self.input_labels = {'training': [], 'validation': []} # pseudo label
    ...
    def load_sub_sampled_clouds(self, sub_grid_size):
        ...
        for i, file_path in enumerate(self.all_files):
            ...
            # load pseudo labels and gt labels
            if self.val_split in cloud_name:
                sub_labels = data['class']
                sub_labels_gt = sub_labels
            else:
                ...
                sub_labels = np.where(gt_labels!=13, gt_labels, pseudo_labels)
...
if __name__ == '__main__':
    ...
    parser.add_argument('--log_dir', type=str, default= 'rfcrnl_Area-5', help='')
    parser.add_argument('--load_dir', type=str, default= 'rfcrnl_Area-5-pretrain', help='')
    parser.add_argument('--gt_label_path', type=str,
                        default='./experiment/S3DIS/1_points_/rfcrnl_Area-5-pretrain/gt_1',
                        help='gt label path')
    parser.add_argument('--pseudo_label_path', type=str,
                        default='./experiment/S3DIS/1_points_/rfcrnl_Area-5-pretrain/prediction/pseudo_label',
    ...
    dataset = S3DIS(test_area, FLAGS.pseudo_label_path, FLAGS.gt_label_path)
