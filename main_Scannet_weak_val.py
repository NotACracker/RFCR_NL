...
from tester_ScanNet_val import ModelTester
...
class ScanNet:
    def __init__(self):
        ...
        self.label_to_names = {1: 'wall', 2: 'floor', 3: 'cabinet', 4: 'bed', 5: 'chair',
...
if __name__ == '__main__':
    ...
    parser.add_argument('--test_file_dir', type=str, default= 'rfcrnl_pretrain', help='')
    ...
    dataset.test_file_dir = FLAGS.test_file_dir
