...
import shutil
import random
from RandLANet_weak_pretrain import Network
...
class S3DIS:
    def __init__(self, test_area_idx, labeled_point, experiment_dir):
        self.name = 'S3DIS'
        ...
        self.load_sub_sampled_clouds(cfg.sub_grid_size, labeled_point, experiment_dir)

    def load_sub_sampled_clouds(self, sub_grid_size, labeled_point, experiment_dir):
...
if __name__ == '__main__':
    ...
    dataset = S3DIS(test_area, FLAGS.labeled_point, experiment_dir)
